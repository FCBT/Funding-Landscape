...
for k in [200]:
    ...
    #read labels
    df_labels = pd.read_csv("./results/fine-scale/mallet-models/STEM/" + str(k) + "-topic-files/1-"+ str(k) +"-keywords-labelled.csv")
    ...
    df_joined.to_csv("./results/fine-scale/tSNE/"+str(k)+"-topics-TSNE_p100.csv", index = False)
