...
df_summary = df_joined.groupby(['Country', 'Topic']).size().unstack().fillna(0)
...
df_dist.to_csv("./results/fine-scale/distances/country-topic-dist.csv")
df_summary.to_csv("./results/fine-scale/distances/country-topic-summary.csv")
