...
corpus = gensim.corpora.MmCorpus('./clean-data/fine-scale/UK-USA/corpus.mm')
...
us_metadata = pd.read_csv("./clean-data/fine-scale/USA/NSF/NSF-project-metadata.csv", dtype="object")
...
#save output
df_meta_joined.to_csv("./results/fine-scale/UK-USA/tnse_df.csv")
