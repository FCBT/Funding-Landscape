...
argv[1] = "./flavia/raw-data/fine-scale/UK/UKRI/"
argv[2] = "./flavia/clean-data/fine-scale/UK/UKRI/"


Example:  python3 code/helper-scripts/data-processing/UKRI_process_raw_data.py ./flavia/raw-data/fine-scale/UK/UKRI/ ./flavia/clean-data/fine-scale/UK/UKRI/
...
def main(argv):
    ...
    data_filtered = ukri_metadata[ukri_metadata.FundingOrgName.isin(["BBSRC","EPSRC", "NERC", "STFC", "MRC", "Innovate UK"])]
