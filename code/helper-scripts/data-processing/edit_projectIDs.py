...
# Autralia 
df = pd.read_csv('/home/flavia/Projects/Funding-Landscape/raw-data/fine-scale/Australia/ACIAR/STEM-ACIAR-raw-text.csv', index_col=False)
df.head()
df = df.rename(columns={'AbstractTitle':'TitleAbstract'})
df.head()
df.columns
df = df.drop(['Unnamed: 0'],axis=1)
df.to_csv('/home/flavia/Projects/Funding-Landscape/raw-data/fine-scale/Australia/ACIAR/titles-abstracts.csv', index= False)
