...
project_metadata = pd.read_csv("/Users/flavia/Library/CloudStorage/OneDrive-ImperialCollegeLondon/Funding-Landscape/raw-data/fine-scale/UK/UKRI/UKRI_raw_metadata.csv")
print("data loaded")
